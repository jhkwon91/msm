package se.magnus.api.composite.product.services;
...
import se.magnus.api.composite.recommendation.RecommendationService;
import se.magnus.api.composite.review.Review;
import se.magnus.api.composite.review.ReviewService;
...
//            Product product = restTemplate.getForObject(url, Product.class);
            ...
            Product product =
                    restTemplate.exchange(url, GET, null, new ParameterizedTypeReference<Product>() {
            }).getBody();
